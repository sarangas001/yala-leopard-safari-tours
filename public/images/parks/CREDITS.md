...
These images are temporary stand-ins sourced from Wikimedia Commons so the hero
section has real photography to work with. Swap them for the operator's own
...
that reason. Remove the credit line once real photography replaces these.
